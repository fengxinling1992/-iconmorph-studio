...
export default function Home() {
  ...
  const activeExtrusionFaces = normalizedExtrusionAngle < 90
    ? ["右边", "底边"]
    : normalizedExtrusionAngle < 180
      ? ["底边", "左边"]
      : normalizedExtrusionAngle < 270
        ? ["左边", "顶边"]
        : ["顶边", "右边"];
